...
{
    public class CreateDyeingRoutingCommandValidator : AbstractValidator<CreateDyeingRoutingCommand>
    {
        private readonly IDyeingIEDRepository _dyeingIed;

        public CreateDyeingRoutingCommandValidator(IDyeingIEDRepository dyeingIed)
        {
