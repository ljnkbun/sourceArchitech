...
{
    public class UpdateDyeingRoutingsCommandValidator : AbstractValidator<UpdateDyeingRoutingsCommand>
    {
          private readonly IDyeingIEDRepository _dyeingIed;

        public UpdateDyeingRoutingsCommandValidator(IDyeingIEDRepository dyeingIed)
        {
