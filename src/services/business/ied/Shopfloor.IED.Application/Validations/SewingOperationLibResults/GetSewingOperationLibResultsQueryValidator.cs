...
{
    public class GetSewingOperationLibResultsQueryValidator : AbstractValidator<GetSewingOperationLibResultsQuery>
    {
        public GetSewingOperationLibResultsQueryValidator()
        {
