...
{
    public class UpdateWeavingReportSettingDetailCommandValidator : AbstractValidator<UpdateWeavingReportSettingDetailCommand>
    {
        private readonly IWeavingReportSettingRepository _weavingReportSetting;

        public UpdateWeavingReportSettingDetailCommandValidator(IWeavingReportSettingRepository weavingReportSetting)
        {
        ...
        private bool IsCheckReportSettingDetail(UpdateWeavingReportSettingDetailCommand data)
        {
