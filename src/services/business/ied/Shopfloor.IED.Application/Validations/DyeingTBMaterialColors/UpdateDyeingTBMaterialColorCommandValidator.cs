...
{
    public class UpdateDyeingTBMaterialColorCommandValidator : AbstractValidator<UpdateDyeingTBMaterialColorCommand>
    {
        private readonly IDyeingTBMaterialRepository _dyeingTbMaterialRepository;

        public UpdateDyeingTBMaterialColorCommandValidator(IDyeingTBMaterialRepository dyeingTbMaterialRepository)
        {
