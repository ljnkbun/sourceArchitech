...
{
    public class UpdateWeavingOperationInputArticleCommandValidator : AbstractValidator<UpdateWeavingOperationInputArticleCommand>
    {
        private readonly IWeavingOperationRepository _weavingOperation;

        public UpdateWeavingOperationInputArticleCommandValidator(IWeavingOperationRepository weavingOperation)
        {
