...
{
    public class UpdateDyeingProcessChemicalCommandValidator : AbstractValidator<UpdateDyeingProcessChemicalCommand>
    {
        private readonly IDyeingRoutingRepository _dyeingRouting;

        public UpdateDyeingProcessChemicalCommandValidator(IDyeingRoutingRepository dyeingRouting)
        {
