...
{
    public class CreateDyeingTBRChemicalValueCommandValidator : AbstractValidator<CreateDyeingTBRChemicalValueCommand>
    {
        private readonly IDyeingTBRChemicalRepository _dyeingTbrChemical;

        public CreateDyeingTBRChemicalValueCommandValidator(IDyeingTBRChemicalRepository dyeingTbrChemical)
        {
