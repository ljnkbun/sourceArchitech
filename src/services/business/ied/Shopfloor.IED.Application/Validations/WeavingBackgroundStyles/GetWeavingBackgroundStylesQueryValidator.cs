...
{
    public class GetWeavingBackgroundStylesQueryValidator : AbstractValidator<GetWeavingBackgroundStylesQuery>
    {
        public GetWeavingBackgroundStylesQueryValidator()
        {
            RuleFor(p => p.Name)
