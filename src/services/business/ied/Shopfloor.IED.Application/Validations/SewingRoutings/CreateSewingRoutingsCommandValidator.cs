...
{
    public class CreateSewingRoutingsCommandValidator : AbstractValidator<CreateSewingRoutingsCommand>
    {
        public CreateSewingRoutingsCommandValidator()
        {
        ...
        private bool IsLineNumberUnique(CreateSewingRoutingsCommand command)
        {
