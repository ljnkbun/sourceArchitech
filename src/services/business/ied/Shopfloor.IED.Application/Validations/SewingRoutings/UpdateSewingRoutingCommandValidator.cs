...
{
    public class UpdateSewingRoutingCommandValidator : AbstractValidator<UpdateSewingRoutingCommand>
    {
        public UpdateSewingRoutingCommandValidator()
        {
        ...
        private bool IsValid(UpdateSewingRoutingCommand command)
        {
        ...
        private bool IsLineNumberUnique(UpdateSewingRoutingCommand command)
        {
