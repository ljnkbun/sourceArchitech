...
{
    public class CreateRecipeChemicalCommandValidator : AbstractValidator<CreateRecipeChemicalCommand>
    {
        private readonly IRecipeTaskRepository _recipeTask;

        public CreateRecipeChemicalCommandValidator(IRecipeTaskRepository recipeTask)
        {
