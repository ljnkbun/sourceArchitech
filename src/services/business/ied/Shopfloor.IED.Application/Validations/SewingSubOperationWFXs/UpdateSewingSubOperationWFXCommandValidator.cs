...
{
    public class UpdateSewingSubOperationWFXCommandValidator : AbstractValidator<UpdateSewingSubOperationWFXCommand>
    {
        public UpdateSewingSubOperationWFXCommandValidator()
        {
        ...
        private bool IsLineNumberUnique(UpdateSewingSubOperationWFXCommand command)
        {
            return command?.SewingSubOperationWFXBOLs.DistinctBy(m => m.LineNumber).Count() == command?.SewingSubOperationWFXBOLs.Count();
        }
        private bool IsValid(UpdateSewingSubOperationWFXCommand command)
        {
