...
{
    public class UpdateSewingOperationWFXCommandValidator : AbstractValidator<UpdateSewingOperationWFXCommand>
    {
        public UpdateSewingOperationWFXCommandValidator()
        {
