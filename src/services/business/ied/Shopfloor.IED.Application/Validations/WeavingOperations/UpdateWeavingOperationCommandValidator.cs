...
{
    public class UpdateWeavingOperationCommandValidator : AbstractValidator<UpdateWeavingOperationCommand>
    {
        private readonly IWeavingOperationRepository _weavingOperation;

        private readonly IWeavingRoutingRepository _weavingRouting;

        public UpdateWeavingOperationCommandValidator(IWeavingOperationRepository weavingOperation, IWeavingRoutingRepository weavingRouting)
        {
