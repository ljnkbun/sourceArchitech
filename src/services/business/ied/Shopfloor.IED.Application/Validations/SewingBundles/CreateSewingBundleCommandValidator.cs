...
{
    public class CreateSewingBundleCommandValidator : AbstractValidator<CreateSewingBundleCommand>
    {
        private readonly ISewingBundleRepository _sewingBundle;

        public CreateSewingBundleCommandValidator(ISewingBundleRepository sewingBundle)
        {
        ...
        {
            return await _sewingBundle.IsUniqueAsync(code);
        }
    }
}