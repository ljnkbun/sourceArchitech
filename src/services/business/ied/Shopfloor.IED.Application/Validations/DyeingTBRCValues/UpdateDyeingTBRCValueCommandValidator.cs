...
{
    public class UpdateDyeingTBRCValueCommandValidator : AbstractValidator<UpdateDyeingTBRCValueCommand>
    {
        ...
        public UpdateDyeingTBRCValueCommandValidator(IDyeingTBRChemicalRepository dyeingTbrChemical, IDyeingTBRVersionRepository dyeingTbrVersion)
        {
