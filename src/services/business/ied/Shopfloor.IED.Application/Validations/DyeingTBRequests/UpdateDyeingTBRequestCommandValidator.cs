...
namespace Shopfloor.IED.Application.Validations.DyeingTBRequests
{
    public class UpdateDyeingTBRequestCommandValidator : AbstractValidator<UpdateDyeingTBRequestCommand>
    {
        ...
        public UpdateDyeingTBRequestCommandValidator(IDyeingTBRequestRepository dyeingTbRequest, IDyeingTBMaterialRepository dyeingTbMaterial)
        {
            ...
            RuleForEach(p => p.DyeingTBMaterials).ChildRules(childDyeingTBMaterial =>
            {
                ...
                childDyeingTBMaterial.RuleFor(p => p.DyeingTBRequestId)
