...
{
    public class CreateDyeingTBRequestFileCommandValidator : AbstractValidator<CreateDyeingTBRequestFileCommand>
    {
        private readonly IDyeingTBRequestRepository _dyeingTbRequestRepository;

        public CreateDyeingTBRequestFileCommandValidator(IDyeingTBRequestRepository dyeingTbRequestRepository)
        {
