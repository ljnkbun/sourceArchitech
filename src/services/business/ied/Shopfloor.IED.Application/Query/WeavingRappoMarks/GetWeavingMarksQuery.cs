...
{
    public class GetWeavingRappoMarksQuery : IRequest<PagedResponse<IReadOnlyList<WeavingRappoMarkModel>>>, ICacheableMediatrQuery
    {
        ...
        public string CacheKey => $"WeavingRappoMarks";
