...
namespace Shopfloor.IED.Infrastructure.Migrations
{
    ...
    [Migration("20231129030913_rename-operationgroup-to-feature")]
    partial class renameoperationgrouptofeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopfloor.IED.Domain.Entities.SewingFeatureMapLib", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SewingFeatureMapLibs");
                });
            ...
            modelBuilder.Entity("Shopfloor.IED.Domain.Entities.SewingMacroMapLib", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopfloor.IED.Domain.Entities.SewingOperationMacroMapLib", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SewingOperationMacroMapLibs");
                });
            ...
            modelBuilder.Entity("Shopfloor.IED.Domain.Entities.SewingOperationMacroMapLib", b =>
                {
                    b.HasOne("Shopfloor.IED.Domain.Entities.SewingMacroLib", "SewingMacroLib")
                        .WithMany("SewingOperationMacroMapLibs")
                        .HasForeignKey("SewingMacroLibId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Shopfloor.IED.Domain.Entities.SewingFeatureLib", b =>
                {
                    b.Navigation("SewingFeatureMapLibs");
                });

            modelBuilder.Entity("Shopfloor.IED.Domain.Entities.SewingMacroLib", b =>
                {
                    b.Navigation("SewingMacroMapLibs");

                    b.Navigation("SewingOperationMacroMapLibs");
                });
