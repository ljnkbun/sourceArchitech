...
namespace Shopfloor.IED.Api.Extensions
{
    public static class ServiceExtensions
    {
        public static void AddEventBus(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddMassTransit(x =>
            {
                ...
                x.AddRequestClient<GetArticlesByIdsRequest>();
                x.AddRequestClient<GetOperationLibrariesRequest>();
                x.AddRequestClient<GetProcessesRequest>();
                x.AddRequestClient<GetDynamicColumnsRequest>();
                x.AddRequestClient<GetSubCategoriesRequest>();
                x.AddRequestClient<GetArticlesRequest>();
