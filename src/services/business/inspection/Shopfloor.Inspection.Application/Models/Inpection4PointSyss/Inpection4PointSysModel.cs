...
namespace Shopfloor.Inspection.Application.Models.Inpection4PointSyss
{
    public class Inpection4PointSysModel : BaseModel
    {
        ...
        public ICollection<InspectionDefectCapturing4PointSysModel> InspectionDefectCapturing4PointSyss { get; set; }
