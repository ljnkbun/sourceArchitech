...
{
    public class CreateProblemCorrectiveActionCommandValidator : AbstractValidator<CreateProblemCorrectiveActionCommand>
    {
        public CreateProblemCorrectiveActionCommandValidator()
        {
