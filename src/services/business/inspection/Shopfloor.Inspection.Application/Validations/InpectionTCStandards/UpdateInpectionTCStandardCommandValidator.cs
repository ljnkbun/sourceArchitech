...
{
    public class UpdateInpectionTCStandardCommandValidator : AbstractValidator<UpdateInpectionTCStandardCommand>
    {
        public UpdateInpectionTCStandardCommandValidator()
        {
