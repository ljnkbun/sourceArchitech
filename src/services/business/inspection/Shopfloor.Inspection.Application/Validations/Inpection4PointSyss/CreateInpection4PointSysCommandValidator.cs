...
{
    public class CreateInpection4PointSysCommandValidator : AbstractValidator<CreateInpection4PointSysCommand>
    {
        public CreateInpection4PointSysCommandValidator()
        {
