...
{
    public class CreateInpection100PointSysCommandValidator : AbstractValidator<CreateInpection100PointSysCommand>
    {
        public CreateInpection100PointSysCommandValidator()
        {
