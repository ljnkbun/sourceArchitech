...
{
    [ApiVersion("1.0")]
    public class Inpection4PointSysController : BaseApiController
    {
        // GET: api/v1/<controller>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Inpection4PointSysParameter filter)
        {
            return Ok(await Mediator.Send(new GetInpection4PointSyssQuery()
            {
        ...
        {
            return Ok(await Mediator.Send(new GetInpection4PointSysQuery { Id = id }));
        }

        // POST api/v1/<controller>
        [HttpPost]
        public async Task<IActionResult> Post(CreateInpection4PointSysCommand command)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, UpdateInpection4PointSysCommand command)
        {
        ...
        {
            return Ok(await Mediator.Send(new DeleteInpection4PointSysCommand { Id = id }));
        }
    }
}
