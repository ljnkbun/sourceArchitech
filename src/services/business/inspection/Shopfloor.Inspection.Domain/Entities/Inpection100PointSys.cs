...
{
    public class Inpection100PointSys : BaseEntity
    {
        public Inpection100PointSys()
        {
            InspectionDefectCapturing100PointSyss = new HashSet<InspectionDefectCapturing100PointSys>();
        ...
        public virtual ICollection<InspectionDefectCapturing100PointSys> InspectionDefectCapturing100PointSyss { get; set; }
