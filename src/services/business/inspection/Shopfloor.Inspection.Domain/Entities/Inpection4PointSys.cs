...
{
    public class Inpection4PointSys : BaseEntity
    {
        public Inpection4PointSys()
        {
            InspectionDefectCapturing4PointSyss = new HashSet<InspectionDefectCapturing4PointSys>();
        ...
        public virtual ICollection<InspectionDefectCapturing4PointSys> InspectionDefectCapturing4PointSyss { get; set; }
