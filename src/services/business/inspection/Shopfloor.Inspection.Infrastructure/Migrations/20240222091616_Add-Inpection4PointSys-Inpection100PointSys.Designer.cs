...
namespace Shopfloor.Inspection.Infrastructure.Migrations
{
    ...
    [Migration("20240222091616_Add-Inpection4PointSys-Inpection100PointSys")]
    partial class AddInpection4PointSysInpection100PointSys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.InspectionDefectError", b =>
                {
                    ...
                    b.Property<int>("InspectionDefectCapturingId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InspectionDefectCapturingId");
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.InspectionDefectError", b =>
                {
                    b.HasOne("Shopfloor.Inspection.Domain.Entities.InspectionDefectCapturing", "InspectionDefectCapturing")
                        .WithMany("InspectionDefectErrors")
                        .HasForeignKey("InspectionDefectCapturingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InspectionDefectCapturing");
                });
