...
namespace Shopfloor.Inspection.Infrastructure.Migrations
{
    ...
    [Migration("20240229073326_Add-Columns-QCRequestArticle")]
    partial class AddColumnsQCRequestArticle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.DefectScoringMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DefectScoringMethod", (string)null);
                });

            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.FabricClassification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FabricClassification", (string)null);
                });
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.Sampling", b =>
                {
                    ...
                    b.Property<int?>("DefectScoringMethodId")
                        .HasColumnType("int");

                    b.Property<int?>("FabricClassificationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DefectScoringMethodId");

                    b.HasIndex("FabricClassificationId");
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.Sampling", b =>
                {
                    ...
                    b.HasOne("Shopfloor.Inspection.Domain.Entities.DefectScoringMethod", "DefectScoringMethod")
                        .WithMany("Samplings")
                        .HasForeignKey("DefectScoringMethodId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Shopfloor.Inspection.Domain.Entities.FabricClassification", "FabricClassification")
                        .WithMany("Samplings")
                        .HasForeignKey("FabricClassificationId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("DefectScoringMethod");

                    b.Navigation("FabricClassification");
