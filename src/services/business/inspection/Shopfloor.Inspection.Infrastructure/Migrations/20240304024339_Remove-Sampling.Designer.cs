...
namespace Shopfloor.Inspection.Infrastructure.Migrations
{
    ...
    [Migration("20240304024339_Remove-Sampling")]
    partial class RemoveSampling
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.FourPointsSystem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FourPointsSystem", (string)null);
                });

            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.FourPointsSystemDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FourPointsSystemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FourPointsSystemId");

                    b.ToTable("FourPointsSystemDetail", (string)null);
                });
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.OneHundredPointSystemDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OneHundredPointSystemId")
                        .HasColumnType("int");

                    b.Property<byte>("Point")
                        .HasColumnType("tinyint");

                    b.Property<int?>("ToDefect")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OneHundredPointSystemId");

                    b.ToTable("OneHundredPointSystemDetail", (string)null);
                });
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.QCRequest", b =>
                {
                    ...
                    b.Property<string>("ProductionOutputCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.QCType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.FourPointsSystemDetail", b =>
                {
                    b.HasOne("Shopfloor.Inspection.Domain.Entities.FourPointsSystem", "FourPointsSystem")
                        .WithMany("FourPointsSystemDetails")
                        .HasForeignKey("FourPointsSystemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FourPointsSystem");
                });
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.OneHundredPointSystem", b =>
                {
                    b.HasOne("Shopfloor.Inspection.Domain.Entities.FabricWeight", null)
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.OneHundredPointSystemDetail", b =>
                {
                    b.HasOne("Shopfloor.Inspection.Domain.Entities.OneHundredPointSystem", "OneHundredPointSystem")
                        .WithMany("OneHundredPointSystemDetails")
                        .HasForeignKey("OneHundredPointSystemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OneHundredPointSystem");
                });
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.QCDefinition", b =>
                {
                    ...
                    b.HasOne("Shopfloor.Inspection.Domain.Entities.QCType", "QCType")
                        .WithMany("QCDefinitions")
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.FourPointsSystem", b =>
                {
                    b.Navigation("FourPointsSystemDetails");
            ...
            modelBuilder.Entity("Shopfloor.Inspection.Domain.Entities.OneHundredPointSystem", b =>
                {
                    b.Navigation("OneHundredPointSystemDetails");
