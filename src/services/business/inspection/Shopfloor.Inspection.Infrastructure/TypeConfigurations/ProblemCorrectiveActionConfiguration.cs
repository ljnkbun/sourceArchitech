...
{
    public class ProblemCorrectiveActionConfiguration : BaseConfiguration<ProblemCorrectiveAction>
    {
        public override void Configure(EntityTypeBuilder<ProblemCorrectiveAction> builder)
        {
