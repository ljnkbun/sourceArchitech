...
{
    public class Inpection4PointSysConfiguration : BaseConfiguration<Inpection4PointSys>
    {
        public override void Configure(EntityTypeBuilder<Inpection4PointSys> builder)
        {
