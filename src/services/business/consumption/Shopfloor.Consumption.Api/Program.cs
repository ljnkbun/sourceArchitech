...
using Shopfloor.Consumption.Api.Extensions;
using Shopfloor.Consumption.Api.Services;
using Shopfloor.Consumption.Application.Extensions;
using Shopfloor.Consumption.Infrastructure.Contexts;
using Shopfloor.Consumption.Infrastructure.Extensions;
using Shopfloor.Consumption.Infrastructure.SeedDatas;
...
{
    var db = scope.ServiceProvider.GetRequiredService<ConsumptionContext>();
    db.Database.Migrate();
