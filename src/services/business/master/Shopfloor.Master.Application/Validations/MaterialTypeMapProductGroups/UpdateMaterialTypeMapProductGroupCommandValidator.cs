...
{
    public class UpdateMaterialTypeMapProductGroupCommandValidator : AbstractValidator<UpdateMaterialTypeMapProductGroupCommand>
    {
        private readonly IProductGroupRepository _productGroupRepository;
        private readonly IMaterialTypeRepository _materialTypeRepository;
        private readonly IMaterialTypeMapProductGroupRepository _materialTypeMapProductGroupRepository;

        public UpdateMaterialTypeMapProductGroupCommandValidator(IProductGroupRepository productGroupRepository, IMaterialTypeRepository materialTypeRepository, IMaterialTypeMapProductGroupRepository materialTypeMapProductGroupRepository)
        {
        ...
        private async Task<bool> IsDuplicateAsync(UpdateMaterialTypeMapProductGroupCommand command, CancellationToken cancellationToken)
        {
            return await _materialTypeMapProductGroupRepository.IsDuplicateAsync(command.MaterialTypeId, command.ProductGroupId, command.Id);
        }
