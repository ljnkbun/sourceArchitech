...
{
    public class UpdateCategoryMapMaterialTypeCommandValidator : AbstractValidator<UpdateCategoryMapMaterialTypeCommand>
    {
        private readonly ICategoryRepository _categoryRepository;
        private readonly IMaterialTypeRepository _materialTypeRepository;
        private readonly ICategoryMapMaterialTypeRepository _categoryMapMaterialTypeRepository;
        public UpdateCategoryMapMaterialTypeCommandValidator(ICategoryRepository categoryRepository, IMaterialTypeRepository materialTypeRepository, ICategoryMapMaterialTypeRepository categoryMapMaterialTypeRepository)
        {
        ...
        private async Task<bool> IsDuplicateAsync(UpdateCategoryMapMaterialTypeCommand command, CancellationToken cancellationToken)
        {
            return await _categoryMapMaterialTypeRepository.IsDuplicateAsync(command.CategoryId, command.MaterialTypeId, command.Id);
        }
    }
}
