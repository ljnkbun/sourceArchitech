...
namespace Shopfloor.Master.Application.Validations.Categories
{
    public class UpdateCategoryCommandValidator : AbstractValidator<UpdateCategoryCommand>
    {
        ...
        private async Task<bool> IsUniqueAsync(UpdateCategoryCommand command, CancellationToken token)
        {
            return await _categoryRepository.IsUniqueAsync(command.Code,command.Id);
        }
    }
}
