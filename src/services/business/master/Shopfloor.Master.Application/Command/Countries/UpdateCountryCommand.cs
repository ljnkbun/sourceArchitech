...
namespace Shopfloor.Master.Application.Command.Countries
{
    ...
    public class UpdateCountryCommandHandler : IRequestHandler<UpdateCountryCommand, Response<int>>
    {
        ...
        public async Task<Response<int>> Handle(UpdateCountryCommand command, CancellationToken cancellationToken)
        {
            var entity = await _repository.GetByIdAsync(command.Id);

            if (entity == null) throw new ApiException($"Country Not Found.");
