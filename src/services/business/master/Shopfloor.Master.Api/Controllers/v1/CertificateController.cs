...
namespace Shopfloor.Master.Api.Controllers.v1
{
    ...
    public class CertificateController : BaseApiController
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] CertificateParameter filter)
        {
        ...
        {
            return Ok(await Mediator.Send(new GetCertificateQuery { Id = id }));
        }
        ...
        {
            return Ok(await Mediator.Send(new DeleteCertificateCommand { Id = id }));
        }
    }
}
