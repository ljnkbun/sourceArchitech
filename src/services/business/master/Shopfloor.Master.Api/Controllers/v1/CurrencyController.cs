...
namespace Shopfloor.Master.Api.Controllers.v1
{
    ...
    public class CurrencyController : BaseApiController
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] CurrencyParameter filter)
        {
        ...
        {
            return Ok(await Mediator.Send(new GetCurrencyQuery { Id = id }));
        }
        ...
        {
            return Ok(await Mediator.Send(new DeleteCurrencyCommand { Id = id }));
        }
    }
}
