...
{
    public class GetLearningCurveEfficienciesQueryValidator : AbstractValidator<GetLearningCurveEfficienciesQuery>
    {
        public GetLearningCurveEfficienciesQueryValidator()
        {
            RuleFor(p => p.Code)
