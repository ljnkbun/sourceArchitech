...
{
    public class CreateStripSchedulePlanningDetailCommandValidator : AbstractValidator<CreateStripSchedulePlanningDetailCommand>
    {
        public CreateStripSchedulePlanningDetailCommandValidator()
        {
