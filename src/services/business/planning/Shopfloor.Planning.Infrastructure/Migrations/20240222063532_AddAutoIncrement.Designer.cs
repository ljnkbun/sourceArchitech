...
namespace Shopfloor.Planning.Infrastructure.Migrations
{
    ...
    [Migration("20240222063532_AddAutoIncrement")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopfloor.Planning.Domain.Entities.AutoIncrement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopfloor.Planning.Domain.Entities.CriticalPart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CriticalPart", (string)null);
                });
            ...
            modelBuilder.Entity("Shopfloor.Planning.Domain.Entities.FPPO", b =>
                {
                    ...
                    b.Property<string>("WFXDeliveryOrderCode")
                        .HasColumnType("varchar(100)");

                    b.Property<int?>("WFXFPPOId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("WipDispatchSite")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<string>("WipReceivingSite")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
            ...
            modelBuilder.Entity("Shopfloor.Planning.Domain.Entities.StripSchedule", b =>
                {
                    ...
                    b.Property<int>("FromWorkingHours")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsManualPlanning")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Shopfloor.Planning.Domain.Entities.StripScheduleCapture", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("StripScheduleCapture", (string)null);
                });
            ...
            modelBuilder.Entity("Shopfloor.Planning.Domain.Entities.StripScheduleDetailCapture", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("StripScheduleCaptureId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StripScheduleCaptureId");

                    b.ToTable("StripScheduleDetailCapture", (string)null);
                });
            ...
            modelBuilder.Entity("Shopfloor.Planning.Domain.Entities.StripSchedulePlanningDetailCapture", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("StripSchedulePlanningDetailCapture", (string)null);
                });
            ...
            modelBuilder.Entity("Shopfloor.Planning.Domain.Entities.StripScheduleDetailCapture", b =>
                {
                    b.HasOne("Shopfloor.Planning.Domain.Entities.StripScheduleCapture", "StripScheduleCapture")
                        .WithMany("StripScheduleDetailCaptures")
                        .HasForeignKey("StripScheduleCaptureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StripScheduleCapture");
                });
            ...
            modelBuilder.Entity("Shopfloor.Planning.Domain.Entities.StripSchedulePlanningDetailCapture", b =>
                {
                    b.HasOne("Shopfloor.Planning.Domain.Entities.StripScheduleCapture", "StripScheduleCapture")
                        .WithMany("StripSchedulePlanningDetailCaptures")
                        .HasForeignKey("StripScheduleCaptureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Shopfloor.Planning.Domain.Entities.StripScheduleCapture", b =>
                {
                    b.Navigation("StripScheduleDetailCaptures");

                    b.Navigation("StripSchedulePlanningDetailCaptures");
                });
