...
{
    public class StripScheduleCaptureConfiguration : BaseConfiguration<StripScheduleCapture>
    {
        public override void Configure(EntityTypeBuilder<StripScheduleCapture> builder)
        {
