...
{
    public class DefectCapturing4PointsConfiguration : BaseConfiguration<DefectCapturing4Points>
    {
        public override void Configure(EntityTypeBuilder<DefectCapturing4Points> builder)
        {
            ...
            builder.HasOne(s => s.ProductionOutput)
                .WithMany(g => g.DefectCapturing4Points)
