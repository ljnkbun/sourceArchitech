...
{
    public class CreateDefectCapturing4PointsCommandValidator : AbstractValidator<CreateDefectCapturing4PointsCommand>
    {
        public CreateDefectCapturing4PointsCommandValidator()
        {
