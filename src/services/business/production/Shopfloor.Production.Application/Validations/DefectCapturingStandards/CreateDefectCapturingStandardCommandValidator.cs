...
{
    public class CreateDefectCapturingStandardCommandValidator : AbstractValidator<CreateDefectCapturingStandardCommand>
    {
        public CreateDefectCapturingStandardCommandValidator()
        {
