...
{
    public class CreateDefectCapturing100PointsCommandValidator : AbstractValidator<CreateDefectCapturing100PointsCommand>
    {
        public CreateDefectCapturing100PointsCommandValidator()
        {
