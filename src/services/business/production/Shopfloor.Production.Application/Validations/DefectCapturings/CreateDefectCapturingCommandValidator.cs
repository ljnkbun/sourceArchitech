...
namespace Shopfloor.Production.Application.Validations.DefectCapturings
{
    public class CreateDefectCapturingCommandValidator : AbstractValidator<CreateDefectCapturingCommand>
    {
        public CreateDefectCapturingCommandValidator()
        {
