...
using Serilog;
using Shopfloor.Barcode.Api.Extensions;
using Shopfloor.Barcode.Api.Services;
using Shopfloor.Barcode.Application.Extensions;
using Shopfloor.Barcode.Application.Settings;
using Shopfloor.Barcode.Infrastructure.Contexts;
using Shopfloor.Barcode.Infrastructure.Extensions;
...
builder.Services.Configure<BarcodeConfig>(configuration.GetSection("BarcodeConfigs"));
...
{
    var db = scope.ServiceProvider.GetRequiredService<BarcodeContext>();
    db.Database.Migrate();
}
