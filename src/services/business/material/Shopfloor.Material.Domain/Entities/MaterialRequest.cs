...
namespace Shopfloor.Material.Domain.Entities
{
    public class MaterialRequest : BaseEntity
    {
        ...
        {
            SupplierWisePurchaseOptions = new HashSet<SupplierWisePurchaseOption>();
        ...
        public virtual ICollection<SupplierWisePurchaseOption> SupplierWisePurchaseOptions { get; set; }

        public virtual ICollection<MOQMSQRoudingOptionItem> MoqmsqRoudingOptionItems { get; set; }
