...
namespace Shopfloor.Material.Infrastructure.Migrations
{
    ...
    [Migration("20231101084215_AddSegmentAndProductCategory")]
    partial class AddSegmentAndProductCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopfloor.Material.Domain.Entities.DetailCurrency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DetailCurrency", (string)null);
                });
            ...
            modelBuilder.Entity("Shopfloor.Material.Domain.Entities.DetailCurrency", b =>
                {
                    b.HasOne("Shopfloor.Material.Domain.Entities.PriceListCurrency", "PriceListCurrency")
                        .WithMany("DetailCurrencies")
                        .HasForeignKey("CurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PriceListCurrency");
                });
