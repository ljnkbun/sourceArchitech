...
{
    public class GetWfxExportSyncResponse
    {
        public GetWfxExportSyncResponse()
        {
            Data = new List<GetWfxExportSyncData>();
        }
        public List<GetWfxExportSyncData> Data { get; set; }
    }

    public class GetWfxExportSyncData
    {
        public GetWfxExportSyncData()
        {
        }
